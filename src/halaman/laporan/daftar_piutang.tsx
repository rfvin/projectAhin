...
const DaftarPiutang : FC = () =>{
    const daftarPiutangRef = collection(db,'daftar_piutang1')
    ...
    const hapusPiutang =async () => {
        const DaftarPiutangRef = doc(db,'daftar_piutang1', objectPiutangSelected.id)
                            ...
                            <div className="modal-dialog modal-lg">
                                <div className="modal-content">
                                    <div className="modal-header blue text-white">
                                        <h5 className="modal-title" id="lihatRiwayatPembelianLabel">RiwayatPembelian</h5>
                                    ...
                                    <div className="modal-footer">
                                        <button type="button" onClick={() => {hapusPiutang()}} className="btn red text-white">Hapus</button>
                                        <button type="button" onClick={() => {setLunasPiutang()}} className="btn green text-white">Lunas</button>
                                    </div>
                                </div>
                            </div>
                        </div>
